...
for (const task of ["compliance", "analyze", "release_listing", "release_check"]) {
...
const IDS: WalkthroughId[] = ["compliance", "analyze", "release_listing", "release_planner"];
...
const narrated: [string, RequestInit, RegExp][] = [
  ...
  ["/admin/tables/results?limit=10&offset=0", {}, /Showing 4 of 4 stored entries/],
];
