        ...
        <nav className="mx-auto flex max-w-6xl gap-0.5 overflow-x-auto px-6">
          {TABS.map((t, i) => (
            ...
            >
              ...
              <span className="tab-underline absolute inset-x-2.5 bottom-0 h-[2px] rounded-full bg-iris-400 shadow-[0_0_12px_rgb(124_107_255/0.6)]" />
            </button>
          ))}
        </nav>
      </header>
